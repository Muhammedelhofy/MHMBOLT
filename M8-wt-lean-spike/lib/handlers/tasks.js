...
//
// Body relocated VERBATIM from the original api/tasks.js (Hobby 12-fn pass 2,
// 2026-07-05). No internal requires to rewrite; only the trailing in-file config
// moved to the api/util.js router (which owns maxDuration). No logic changed.
