...
//
// Body relocated VERBATIM from the original api/transcribe.js (Hobby 12-fn pass 2,
// 2026-07-05). No requires to rewrite; the trailing in-file bodyParser config
// moved to the api/util.js router (which owns it). No logic changed.
